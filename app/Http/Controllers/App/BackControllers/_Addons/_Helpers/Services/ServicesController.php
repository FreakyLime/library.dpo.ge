...
use App\Models\App\BackModels\_Addons\Helpers\Services\ServicesModel;
...
class ServicesController extends MainController
{
    //პარამეტრების განსაზღვრა სურათის ასატვირთად
      ...
      public  $root   = "files/services/"; /*მისამართი სურათის ასატვირთად public-ფოლდეიდან*/

    public  function Load($menu_id, ServicesModel $servicesModel){
    ...
    public function SaveService(Request $request, ServicesModel $servicesModel, ImageLybrary $imageLybrary){
    ...
    public function EditService($service_item_id, ServicesModel $servicesModel){
    ...
    public function UpdateService(Request $request, ServicesModel $servicesModel, ImageLybrary $imageLybrary){
    ...
    public function DeleteService($record_item_id, ServicesModel $servicesModel, ImageLybrary $imageLybrary){
