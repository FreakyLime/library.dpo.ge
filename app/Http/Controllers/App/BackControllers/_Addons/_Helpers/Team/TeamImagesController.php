...
class TeamImagesController extends MainController
{
    ...
    public function SaveMoreImages(Request $request, MoreImages $MoreImages, ImageLybrary $imageLybrary){
        ...
        return Redirect("admin/edit_team_item/".$product_images['record_item_id']."#images");
    }
    ...
    public function DeleteImage($item_id, $img_id, MoreImages $moreImages, ImageLybrary $imageLybrary){
        ...
        return Redirect("admin/edit_team_item/".$item_id."#images");
    }
