...
$(function() {
  $('.dd').nestable({
    dropCallback: function(details) {
       ...
       $.post('{{URL::route("manage_blog_reorder")}}',
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="well">
        <p class="lead bpg_caps fbold"><a href="#newModal" class="btn btn-default pull-right" data-toggle="modal"><span class="glyphicon glyphicon-plus-sign"></span> ახალი კატეგორიის დამატება</a> არსებული მენიუები:</p>
        <div class="dd" id="nestable">
          <?php echo $blog ?>
        </div>

        <p id="success-indicator" style="display:none; margin-right: 10px;">
          <span class="glyphicon glyphicon-ok"></span> კატეგორიის სორტირება წარმატებით განხორციელდა!
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {{ Form::open(array('route'=>'manage_blog_new','class'=>'form-horizontal','role'=>'form'))}}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">ახალი კატეგორიის შექმნა</h4>
                </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {{ Form::open(array('route'=>'manage_blog_delete')) }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Provide details of the new blog item</h4>
                </div>
                <div class="modal-body">
