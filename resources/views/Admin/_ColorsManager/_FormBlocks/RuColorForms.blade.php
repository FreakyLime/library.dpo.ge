...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($ProductItem['short_text_ru'])) { ?>
...
<div class="form-group col-md-12 col-sm-12">
    ...
    <? if(isset($ProductItem['full_text_ru'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($ProductItem['description_ru'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($ProductItem['keywords_ru'])) { ?>
