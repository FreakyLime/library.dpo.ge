...
@section('content')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase bpg_caps"> ახალი ოთახის დამატება</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group open">
                            <a href="{{ asset($lang) }}/admin/color_category/{{ $menu_id }}" class="btn btn-lg purple bpg_caps f18">
                ...
                <form action="{{route($route)}}"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 pad_left0">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 365px; height: 220px;">
                                            <img src="
                                                <?php if(isset($ColorItem->image)) echo asset('public/'.$ColorItem->image);
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="portlet_tab1">
                                           {{--ქართული კონტენტი--}}
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._ColorsManager._FormBlocks.GeColorForms')
                                                </div>
                                            </div>
                                           {{--ქართული კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab2">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._ColorsManager._FormBlocks.EnColorForms')
                                                </div>
                                            </div>
                                            {{--ინგლისური კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab3">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._ColorsManager._FormBlocks.RuColorForms')
                                                </div>
                                            </div>
                                            {{--რუსული კონტენტი--}}
                                        </div>
                    ...
                    <?php if(isset($ColorItem)){?> <input type="hidden" name="record_item_id" value="{{$ColorItem['id']}}"><?}?> {{--ოთახის ID-ი რედაქტირების შემთხვევაში--}}
                    <input type="hidden" name="type" value="{{$menu_id}}"> {{----ოთახის ტიპი (ინტერიერი/ ექსტერიერი) --}}
    ...
    {{--MORE IMAGES BOX--}}
    <?php if(isset($ColorImages)){?>
        @include('Admin._ColorsManager._ColorImages.ColorImages')
    <?}?>
    {{--MORE IMAGES BOX--}}
