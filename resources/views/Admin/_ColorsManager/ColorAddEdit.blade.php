        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet light bordered">
                ...
                <form action="{{route($route)}}"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 pad_left0">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 365px; height: 220px;">
                                            <img src="
                                                <? if(isset($ColorItem->image)) echo asset('public/'.$ColorItem->image);
                    ...
                    <? if(isset($ColorItem)){?> <input type="hidden" name="record_item_id" value="{{$ColorItem['id']}}"><?}?> {{--ოთახის ID-ი რედაქტირების შემთხვევაში--}}
