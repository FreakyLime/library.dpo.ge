...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($ProductItem['sale_price'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($ProductItem['short_text_ge'])) { ?>
...
<div class="form-group col-md-12 col-sm-12">
    ...
    <? if(isset($ProductItem['full_text_ge'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($ProductItem['description_ge'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($ProductItem['keywords_ge'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <select class="form-control" name="aromat">
        @foreach($Aromats as $item)
            <option value="{{ $item->id }}"  <? echo (isset($ProductItem["aromat"]) && $ProductItem["aromat"] == $item->id)  ? ' selected="selected"' :''?> >{{ $item->title_ge }}</option>
        @endforeach
    </select>
</div>
<div class="form-group col-md-6 col-sm-6">
    ...
    <select class="form-control" name="main">
        <option value="1" <? if(isset($ProductItem["main"]) == 1)  echo ' selected="selected"'?>>მნიშვნელოვანი პროდუქტი</option>
        <option value="0" <? if(isset($ProductItem["main"]) == 0)  echo ' selected="selected"'?>>ჩვეულებრივი პროდუქტი</option>
    </select>
</div>
<p></p>