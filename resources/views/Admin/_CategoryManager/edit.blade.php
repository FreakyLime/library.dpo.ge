    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <div class="portlet light bordered">
                ...
                <form action="{{route('manage_category_post_edit')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="portlet_tab1">
                                            {{--ქართული კონტენტი--}}
                                            @include('Admin._CategoryManager._Forms.GeCategoryForms')
                                            {{--ქართული კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab2">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    {{--ტექსტარეა ინგლისური--}}
                                                    @include('Admin._CategoryManager._Forms.EnCategoryForms')
                                                    {{--ტექსტარეა ინგლისური--}}
                                        ...
                                        <div class="tab-pane" id="portlet_tab3">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    {{--ტექსტარეა რუსული--}}
                                                    @include('Admin._CategoryManager._Forms.RuCategoryForms')
                                                    {{--ტექსტარეა რუსული--}}
