    ...
    <div class="form-body">
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <select class="form-control" name="target">
                <option value="_self" <? if($Category["target"] == '_self')  echo ' selected="selected"'?>>გაიხსნას არსებულ ფანჯარაში</option>
                <option value="_blank" <? if($Category["target"] == '_blank')  echo ' selected="selected"'?>>გაიხსნას ახალ ფანჯარაში</option>
            </select>
        </div>
