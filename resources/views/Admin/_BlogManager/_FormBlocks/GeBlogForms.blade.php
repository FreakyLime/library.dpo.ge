...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($BlogItem['short_text_ge'])) { ?>
...
<div class="form-group col-md-12 col-sm-12">
    ...
    <? if(isset($BlogItem['full_text_ge'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <? if(isset($BlogItem['description_ge'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <select class="form-control" name="main">
        <option value="1" <? if((isset($BlogItem["main"]) && $BlogItem["main"])  == 1)  echo ' selected="selected"'?>>მნიშვნელოვანი პროდუქტი</option>
        <option value="0" <? if((isset($BlogItem["main"]) && $BlogItem["main"])  == 0)  echo ' selected="selected"'?>>ჩვეულებრივი პროდუქტი</option>
    </select>
</div>
<p></p>