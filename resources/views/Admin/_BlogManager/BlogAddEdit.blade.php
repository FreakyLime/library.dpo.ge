            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase bpg_caps"> ახალი პოსტის დამატება</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group open">
                            <a href="{{ asset($lang) }}/admin/blog_category/{{ $menu_id }}" class="btn btn-lg purple bpg_caps f18">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="portlet_tab1">
                                           {{--ქართული კონტენტი--}}
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._BlogManager._FormBlocks.GeBlogForms')
                                                </div>
                                            </div>
                                           {{--ქართული კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab2">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._BlogManager._FormBlocks.EnBlogForms')
                                                </div>
                                            </div>
                                            {{--ინგლისური კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab3">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._BlogManager._FormBlocks.RuBlogForms')
                                                </div>
                                            </div>
                                            {{--რუსული კონტენტი--}}
                                        </div>
