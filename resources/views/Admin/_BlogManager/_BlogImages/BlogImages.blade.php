<div class="row" id="images">
    <div class="col-md-12 ">
        ...
        <div class="portlet light bordered">
            ...
            <form action="{{route($BlogImgRoute)}}"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="cbp-item graphic">
                                    <div class="cbp-caption" >
                                        <div class="cbp-caption-defaultWrap" >
                                            <img src="{{ asset('public/'.$BlogImage->image) }}" class="admin_gallery_tumb">
                                        </div>
                                        <div class="cbp-caption-activeWrap">
                                            <div class="cbp-l-caption-alignCenter">
                                                <div class="cbp-l-caption-body">
                                                    <a href="{{ asset($lang) }}/admin/blog_images/delate/{{ $BlogImage->id }}/{{ $BlogItem->id }}" class="cbp-l-caption-buttonLeft btn red uppercase btn red uppercase padding_all_10 bpg_caps fbold">
                                                        წაშლა
                                                    </a>
                                                    <a href="{{ asset('public/'.$BlogImage->image) }}" class="cbp-lightbox cbp-l-caption-buttonRight btn red uppercase btn red uppercase padding_all_10 bpg_caps fbold" data-title="{{ $BlogImage['title_'.$lang] }}">
                                                        გადიდება
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="cbp-l-grid-projects-title uppercase text-center uppercase text-center">{{ $BlogImage['title_'.$lang] }}</div>
                                </div>
                            @endforeach
                        </div>
                        {{--IMAGE LOOP--}}
