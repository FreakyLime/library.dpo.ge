...
<div class="form-group col-md-12 col-sm-12">
    ...
    <div class="input-group">
        ...
        <? if(isset($ServiceItem['short_text_ge'])) { ?>
...
<div class="form-group col-md-12 col-sm-12">
    ...
    <select class="form-control" name="main">
        <option value="1" <? if(isset($ServiceItem["main"]) && isset($ServiceItem["main"]) == 1)  echo ' selected="selected"'?>>მნიშვნელოვანი სერვისი</option>
        <option value="0" <? if(isset($ServiceItem["main"]) && isset($ServiceItem["main"]) == 0)  echo ' selected="selected"'?>>ჩვეულებრივი სერვისი</option>
    </select>
</div>
<p></p>