            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase bpg_caps"> ახალი გამოხმაურების ჩამატება</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group open">
                            <a href="{{ asset($lang) }}/admin/reply/{{ $menu_id }}" class="btn btn-lg purple bpg_caps f18">
                ...
                <form action="{{route($route)}}"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 pad_left0">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 365px; height: 220px;">
                                            <img src="
                                                <?php if(isset($ReplyItem->image)) echo asset('public/'.$ReplyItem->image);
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="portlet_tab1">
                                           {{--ქართული კონტენტი--}}
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._Helpers._Reply._FormBlocks.GeReplyForms')
                                                </div>
                                            </div>
                                           {{--ქართული კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab2">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._Helpers._Reply._FormBlocks.EnReplyForms')
                                                </div>
                                            </div>
                                            {{--ინგლისური კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab3">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._Helpers._Reply._FormBlocks.RuReplyForms')
                                                </div>
                                            </div>
                                            {{--რუსული კონტენტი--}}
                                        </div>
                    ...
                    <?php if(isset($ReplyItem)){?> <input type="hidden" name="current_image" value="{{$ReplyItem['image']}}"><?}?> {{--არსებობს თუ არა სურათის რედქატირების დროს--}}
                    <?php if(isset($ReplyItem)){?> <input type="hidden" name="current_tumb" value="{{$ReplyItem['tumb']}}"><?}?> {{--არსებობს თუ არა პატარა სურათის რედქატირების დროს--}}
                    <?php if(isset($ReplyItem)){?> <input type="hidden" name="record_item_id" value="{{$ReplyItem['id']}}"><?}?> {{--პროდუქციის ID-ი რედაქტირების შემთხვევაში--}}
