        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet light bordered">
                ...
                <form action="{{route($route)}}"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 pad_left0">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 365px; height: 220px;">
                                            <img src="
                                                <? if(isset($ReplyItem->image)) echo asset('public/'.$ReplyItem->image);
                    ...
                    <? if(isset($ReplyItem)){?> <input type="hidden" name="current_image" value="{{$ReplyItem['image']}}"><?}?> {{--არსებობს თუ არა სურათის რედქატირების დროს--}}
                    <? if(isset($ReplyItem)){?> <input type="hidden" name="current_tumb" value="{{$ReplyItem['tumb']}}"><?}?> {{--არსებობს თუ არა პატარა სურათის რედქატირების დროს--}}
                    <? if(isset($ReplyItem)){?> <input type="hidden" name="record_item_id" value="{{$ReplyItem['id']}}"><?}?> {{--პროდუქციის ID-ი რედაქტირების შემთხვევაში--}}
