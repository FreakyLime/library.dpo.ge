...
@section('content')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase bpg_caps"> ახალი სერვისის დამატება</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group open">
                            <a href="{{ asset($lang) }}/admin/services_item/{{ $menu_id }}" class="btn btn-lg purple bpg_caps f18">
                ...
                <form action="{{route($route)}}"  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="portlet_tab1">
                                           {{--ქართული კონტენტი--}}
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._Helpers._ServicesItems._FormBlocks.GeProductForms')
                                                </div>
                                            </div>
                                           {{--ქართული კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab2">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._Helpers._ServicesItems._FormBlocks.EnProductForms')
                                                </div>
                                            </div>
                                            {{--ინგლისური კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab3">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._Helpers._ServicesItems._FormBlocks.RuProductForms')
                                                </div>
                                            </div>
                                            {{--რუსული კონტენტი--}}
                                        </div>
                    ...
                    <? if(isset($TableItem)){?> <input type="hidden" name="record_item_id" value="{{$TableItem['id']}}"><?}?> {{--პროდუქციის ID-ი რედაქტირების შემთხვევაში--}}
    ...
    <? if(isset($TableImages)){?>
        @include('Admin._Helpers._ServicesItems._ServicesImages.ServicesImages')
    <?}?>
    {{--MORE IMAGES BOX--}}
