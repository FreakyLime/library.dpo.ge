...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <?php if(isset($TableItem['goal'])) { ?>
        {{ Form::text('goal',$TableItem['goal'], array('class'=>'form-control','placeholder'=>'ბიუჯეტი')) }}
        <?} else{?>
        {{ Form::text('goal',null, array('class'=>'form-control','placeholder'=>'ბიუჯეტი')) }}
        <?}?>
    </div>
</div>
<p></p>
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <?php if(isset($TableItem['time_end'])) { ?>
        {{ Form::date('time_end',$TableItem['time_end'], array('class'=>'form-control','placeholder'=>'დასრულების თარიღი')) }}
        <?} else{?>
        {{ Form::date('time_end',null, array('class'=>'form-control','placeholder'=>'დასრულების თარიღი')) }}
        <?}?>
    </div>
</div>
<p></p>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <select class="form-control" name="main">
        <option value="1" <?php if(isset($TableItem["main"]) && $TableItem["main"] == 1) echo ' selected="selected"'?>>მნიშვნელოვანი სერვისი</option>
        <option value="0" <?php if(isset($TableItem["main"]) && $TableItem["main"] == 0)  echo ' selected="selected"'?>>ჩვეულებრივი სერვისი</option>
    </select>
</div>
<p></p>