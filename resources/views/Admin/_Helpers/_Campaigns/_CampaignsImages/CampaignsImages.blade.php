        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase bpg_caps"> ივენთების დამატებითი სურათები</span>
                </div>
            </div>
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                                        ...
                                        <div class="cbp-caption-activeWrap">
                                            <div class="cbp-l-caption-alignCenter">
                                                <div class="cbp-l-caption-body">
                                                    <a href="{{ asset($lang) }}/admin/campaign_images/delate/{{ $TableItem['id'] }}/{{ $TableImage->id }}" class="cbp-l-caption-buttonLeft btn red uppercase btn red uppercase padding_all_10 bpg_caps fbold">
                                                        წაშლა
                                                    </a>
