...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <?php if(isset($SaleItem['title_en'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <?php if(isset($SaleItem['short_text_en'])) { ?>
...
<div class="form-group col-md-12 col-sm-12">
    ...
    <?php if(isset($SaleItem['full_text_en'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <?php if(isset($SaleItem['description_en'])) { ?>
...
<div class="form-group col-md-6 col-sm-6">
    ...
    <div class="input-group">
        ...
        <?php if(isset($SaleItem['keywords_en'])) { ?>
