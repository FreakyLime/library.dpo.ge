...
@section('content')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase bpg_caps"> ახალი ფასდაკლების დამატება</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group open">
                            <a href="{{ asset($lang) }}/admin/sale_category/{{ $menu_id }}" class="btn btn-lg purple bpg_caps f18">
                                ...
                                <div class="col-md-12 pad_left0">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 365px; height: 220px;">
                                            <img src="
                                                <?php if(isset($SaleItem->image)) echo asset('public/'.$SaleItem->image);
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="portlet_tab1">
                                           {{--ქართული კონტენტი--}}
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._SalesManager._FormBlocks.GeSaleForms')
                                                </div>
                                            </div>
                                           {{--ქართული კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab2">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._SalesManager._FormBlocks.EnSaleForms')
                                                </div>
                                            </div>
                                            {{--ინგლისური კონტენტი--}}
                                        </div>
                                        <div class="tab-pane" id="portlet_tab3">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    @include('Admin._SalesManager._FormBlocks.RuSaleForms')
                                                </div>
                                            </div>
                                            {{--რუსული კონტენტი--}}
                                        </div>
    ...
    {{--MORE IMAGES BOX--}}
    <?php if(isset($SaleImages)){?>
        @include('Admin._SalesManager._SaleImages.SaleImages')
    <?}?>
    {{--MORE IMAGES BOX--}}
