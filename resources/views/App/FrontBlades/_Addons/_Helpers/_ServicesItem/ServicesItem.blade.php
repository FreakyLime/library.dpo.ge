                                            ...
                                            <section class="blog-style-1 news-grid news-list">
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        {{--სიახლეების მოდული--}}
                                                        @foreach($PageServicesItem as $item)
                                                            <div class="col-md-6 col-sm-6" >
                                                                <div class="style-1">
                                                                    <div class="row" style="min-height: 155px !important;">
                                                                        <div class="col-md-3">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <div class="text-box">
                                                                                ...
                                                                                <h3><a href="{{ asset('services/reed/'.$item->id) }}" class="bpg_caps f18 lheight0">{{ $item['title_'.$lang] }}</a></h3>


                                                                                <p class="bpg_arial trim3">{{ $item['short_text_'.$lang] }}</p>
                                                                                <a href="{{ asset('services/reed/'.$item->id) }}" class="btn-more pd-t-0">{{ trans('web.reed_more') }}</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
