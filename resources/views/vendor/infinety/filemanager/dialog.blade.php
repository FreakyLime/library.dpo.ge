...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="{{ asset('/public/filemanager_assets/vendor/dmuploader/css/uploader.css') }}">
        <link type="text/css" rel="stylesheet" href="{{ asset('/public/filemanager_assets/css/filemanager.css') }}">
        ...
        <link type="text/css" rel="stylesheet" href="{{ asset('/public/filemanager_assets/vendor/contextMenu/dist/jquery.contextMenu.css') }}">
        <link type="text/css" rel="stylesheet" href="{{ asset('/public/filemanager_assets/vendor/highlight/styles/agate.css') }}">
    ...
    <body>
        ...
        <script src="{{ asset('/public/filemanager_assets/vendor/pdfobject.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('/public/filemanager_assets/vendor/contextMenu/dist/jquery.contextMenu.js') }}" type="text/javascript"></script>
        <script src="{{ asset('/public/filemanager_assets/vendor/contextMenu/dist/jquery.ui.position.min.js') }}" type="text/javascript"></script>

        <script src="{{ asset('/public/filemanager_assets/vendor/highlight/highlight.pack.js') }}" type="text/javascript"></script>

        <script src="{{ asset('/public/filemanager_assets/vendor/dmuploader/js/dmuploader.js') }}" type="text/javascript"></script>
        <script src="{{ asset('/public/filemanager_assets/vendor/dmuploader/js/gallery.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('public/filemanager_assets/js/filemanager.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('public/filemanager_assets/js/upload.js') }}" type="text/javascript"></script>
    </body>
</html>