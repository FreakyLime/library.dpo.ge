...
<table class="table table-responsive table-condensed table-striped hidden-xs">
  <thead>
    <th style='width:50%;'>{{ Lang::get('laravel-filemanager.title-item') }}</th>
    <th>{{ Lang::get('laravel-filemanager.title-size') }}</th>
    <th>{{ Lang::get('laravel-filemanager.title-type') }}</th>
    <th>{{ Lang::get('laravel-filemanager.title-modified') }}</th>
    <th>{{ Lang::get('laravel-filemanager.title-action') }}</th>
  </thead>
  <tbody>
...
@else
<p>{{ trans('laravel-filemanager.message-empty') }}</p>
@endif
