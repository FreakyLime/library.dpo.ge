<div class="row">
  ...
  <div class="col-md-4">
    <div class="text-center">
      ...
      <button class="btn btn-primary" onclick="performCrop()">{{ trans('laravel-filemanager.btn-crop') }}</button>
      <button class="btn btn-primary" onclick="performCropNew()">{{ trans('laravel-filemanager.btn-copy-crop') }}</button>
